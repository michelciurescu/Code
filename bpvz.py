...
func.SetParameters(50000,1116,1.36,50000,1.36, -155000,150) 
...
Y = hist.GetYaxis()
Y.SetTitle("# #bar{#Lambda_{0}} with -400#leqB_PV_Z#leq-350 (#frac{MeV}{c^{2}})")
for i in range(entries):
    MyTree.GetEntry(i)
    if -400 <= MyTree.Lambda_B_PV_Z <= -350 and MyTree.Lambda_ID < 0:
